...
class Music(commands.Cog):
    ...
    async def start_nodes(self):
        await self.pomice.create_node(bot=self.bot, host='lava.devin-dev.xyz', port='3888', password='ayraiscute', identifier='RussianMartabak', spotify_client_id=None, spotify_client_secret=None)
